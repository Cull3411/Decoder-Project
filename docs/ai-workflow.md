...
3. Verify against the known-good [Transponder ID 1](https://github.com/Cull3411/Transponder-Project/blob/main/firmware/Transponder_ID1/Transponder_ID1.ino) emitter.
...
- Gap average near 12.5 ms when ID 1 is transmitting
